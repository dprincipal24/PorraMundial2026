...
const DOWNSTREAM: Record<number, { homeFrom: number; awayFrom: number }> = {
  89: { homeFrom: 73, awayFrom: 74 }, 90: { homeFrom: 75, awayFrom: 76 },
  91: { homeFrom: 77, awayFrom: 78 }, 92: { homeFrom: 79, awayFrom: 80 },
  93: { homeFrom: 81, awayFrom: 82 }, 94: { homeFrom: 83, awayFrom: 84 },
  95: { homeFrom: 85, awayFrom: 86 }, 96: { homeFrom: 87, awayFrom: 88 },
